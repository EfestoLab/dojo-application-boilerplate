require({
    ...
    packages: [
        { name: 'dojo', location: 'javascript/dojo/release-1.8.3/dojo'},
        { name: 'dijit', location: 'javascript/dojo/release-1.8.3/dijit'},
        { name: 'dojox', location: 'javascript/dojo/release-1.8.3/dojox'},
        // Dgrid modules
